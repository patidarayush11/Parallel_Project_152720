...
import com.capgemini.wallet.dao.JPAWalletDao;
...
public class WalletService implements IWalletService 
{
	...
	JPAWalletDao jpa=new JPAWalletDao();
	...
	{
		return jpa.addUserDetails(user);
	}
	...
	{
		return jpa.getUserDetails(uid);
	}

	@Override
	public double showBalance(int uid) 
	{
		return jpa.showBalance(uid);
	}
	...
	public double deposit(WalletBean user, double amount) 
	{
		...
		return jpa.deposit(user, amount);
